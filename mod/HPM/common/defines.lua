...
country = {
    ...
    COLONIAL_RANK = 25, -- Minimum rank a nation must have to send colonists
    COLONY_TO_STATE_PRESTIGE_GAIN = 20, -- Prestige gain when turning colony to state
    ...
    MOBILIZATION_SPEED_BASE = 0.30, -- Base speed for raising troops
    ...
    MAX_RESEARCH_POINTS = 38000, -- max RP you can store for uncivs
},
...
diplomacy = {
    ...
    WARSUBSIDY_RELATION_ON_ACCEPT = 200,
    WARSUBSIDY_DIPLOMATIC_COST = 3,
    ...
    GW_INTERVENE_MIN_RELATIONS = 1, -- minimum relations required to intervene in great war
    GW_INTERVENE_MAX_EXHAUSTION = 50, -- max war exhaustion required to intervene in great war
    ...
    CRISIS_WINNER_PRESTIGE_FACTOR_BASE = 50,
    CRISIS_WINNER_PRESTIGE_FACTOR_YEAR = 0.4,
    CRISIS_WINNER_RELATIONS_IMPACT = 100, -- negative for losers and backers with unfulfilled goals
    ...
    CRISIS_INTEREST_WAR_EXHAUSTION_LIMIT = 10, -- GPs with WE above this will not get invited to a crisis
...
pops = {
    ...
    MIL_HIT_FROM_CONQUEST = 7, -- how much militancy grows in a province if taken without being core.
    ...
    REBEL_OCCUPATION_STRENGTH_BONUS = 0.001, -- the amount of strength given to rebel movements when they occupy a province
