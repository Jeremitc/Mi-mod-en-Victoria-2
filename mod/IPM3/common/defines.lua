...
country = {
	...
	MOVEMENT_RADICALISM_NATIONALISM_FACTOR = 2.0,
	...
	INVESTMENT_SCORE_FACTOR = 0.01, -- how much foreign investment money counts towards your industry score ex 0.005
	...
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 0.5, -- cost reduction factor if overlord has research the tech ex 0.5
	MAX_SUPPRESSION = 100,
	...
	NEWSPAPER_PRINTING_FREQUENCY = 240, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 720, -- the max period for news that may be printed. The probability is decreased with time.
	NEWSPAPER_MAX_TENSION = 600, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately.
	...
	PARTY_LOYALTY_HIT_ON_WAR_LOSS = 0.85, -- Drops the ruling party loyalty if war is lost.
...
economy = {
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.001, -- Percent increased chance that artisan wants to change goods independantly of how well he is doing presently ex0
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.25, -- fraction of ships in the navy that should be ships of the line ex.4
	AI_LIGHTSHIP_PROPORTION = 0.35, -- fraction of ships in the navy that should be cruisers, frigates etc
	AI_TRANSPORT_PROPORTION = 0.4, -- fraction of ships in the navy that should be should be transports ex-2
	...
	AI_ESCORT_RATIO = 1, -- ratio of escorts to transports in invasion fleets ex2.0
	...
	AI_BLOCKADE_RANGE = 270, -- max distance the AI will send out blockade fleets from their home base ex 250
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.20, -- how little supply is acceptable before getting damage to STR
...
diplomacy = {
	...
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 4,
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 4,
	INFAMY_COLONY = 0,
	...
	GW_INTERVENE_MIN_RELATIONS = 75, -- minimum relations required to intervene in great war
	GW_INTERVENE_MAX_EXHAUSTION = 15, -- max war exhaustion required to intervene in great war ex 1
	GW_JUSTIFY_CB_BADBOY_IMPACT = 0.25, -- % deduction of infamy cost for justify CB in great war ex 0.33
	GW_CB_CONSTRUCTION_SPEED = 0.25, -- faster CB construction against enemies while at great war ex 0.25
	GW_WARGOAL_JINGOISM_REQUIREMENT_MOD = 0.25, -- % deduction of required jingoists in country
	GW_WARSCORE_COST_MOD = 0.55, -- cost reduction factor on warscore needed to fulfill goal if great war ex 0.65
	GW_WARSCORE_COST_MOD_2 = 0.2, -- cost reduction factor on warscore needed to fulfill goal if late game great war ex 0.3
	GW_WARSCORE_2_THRESHOLD = 35, -- warscore threshold where a GW turns into a world war for winner side ex 50
	TENSION_DECAY = -0.08,
...
pops = {
	...
	SLAVE_GROWTH_DIVISOR = 5, -- Slaves have N times lower growth ex10
...
ai =
{
	...
	CAPITALIST_FRACTION = 0.01, -- max amount of population AI wants to be capis ex0.005
	...
	FLEET_SIZE = 20, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI) ex30
	...
	MAX_FLEETS = 30, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions) ex20
	MONTHS_BEFORE_DISBAND = 8, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil) ex6
},
