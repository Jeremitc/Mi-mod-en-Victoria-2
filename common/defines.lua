...
diplomacy = {
	...
	GW_INTERVENE_MIN_RELATIONS = 10, -- minimum relations required to intervene in great war
	...
	GW_CB_CONSTRUCTION_SPEED = 0.50, -- faster CB construction against enemies while at great war
